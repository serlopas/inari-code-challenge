...
from app.logging.schemas import RequestJsonLogSchema
...
class LoggingMiddleware:
    ...
    async def get_request_body(self, request: Request) -> bytes:
        ...
        request._receive = ReceiveProxy(receive=request.receive, cached_body=body)  # pylint: disable=W0212
        return body
    ...
    async def __call__(
        ...
        **kwargs,
        ...
        request_json_fields = RequestJsonLogSchema(
            ...
            x_amzn_trace_id=request_headers.get("x-amzn-requestid"),
            # Response side
